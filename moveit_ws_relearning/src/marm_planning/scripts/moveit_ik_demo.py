...
class MoveItIkDemo:
    def __init__(self):
        ...
        # 控制机械臂终端向右移动5cm
        # x y z r p y -> 0 1 2 3 4 5
        arm.shift_pose_target(1, -0.05, end_effector_link)  # y方向，移动-5cm
        arm.go()
        rospy.sleep(1)
  
        # 控制机械臂终端反向旋转90度
        arm.shift_pose_target(3, -1.57, end_effector_link)  # r方向，旋转 -1.57弧度(90 * Pi / 180 = Pi / 2 = 3.1415 / 2 = 1.57)
        arm.go()
        rospy.sleep(1)
